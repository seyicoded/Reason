            ...
            if( results.length > 0 ){
                ...
                try {
                    await sendMail({
                        ...
                        html: `
                            <h1 style='text-align: center'>Activate Account</h1>
                            <a href='${'http://'+(req.hostname)}/user/account-validate/${generateJwtToken(results[0])}'>click here to activate account, valid for 2 hours, request another if expired</a>
                        `,
                    })  
